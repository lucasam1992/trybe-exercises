...
//EXERCICIO 4
//Retorne todos os documentos em que o atributo name.first seja igual a John , 
...
// PRIMEIRAMENTE - IMPORTAR ARQUIVO BOOK.JSON
...
db.books.find({status:"MEAP"}, {_id:1,title:1,author:1,}).skip(5).limit(10);
