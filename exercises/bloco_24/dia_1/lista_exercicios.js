...
//Exercício 8 : Utilize o operador $min para alterar o budget 
//para 5 do filme Home Alone .
db.movies.updateOne(
    {title:"Home Alone"},
    {$min:{budget:5}}
);
...
//Exercício 10 : Utilizando o operador $currentDate , crie um campo 
//chamado lastUpdated com o tipo timestamp no filme Home Alone .
db.movies.updateOne(
    {title:"Home Alone"},
    { $currentDate:{
