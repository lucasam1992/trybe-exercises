# Criação de um seletor para realizar extrações dos dados da page
...
# Extraindo todos os livros da primeira pagina- buscar titulo e preco
...
# Para mais infos a respeito dos seletores css e xpath
# https://devhints.io/css
# https://devhints.io/xpath


# Recursos Paginados
# Procurando proxima pagina
