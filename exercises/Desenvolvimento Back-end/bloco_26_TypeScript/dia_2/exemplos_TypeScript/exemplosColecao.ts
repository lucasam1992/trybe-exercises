...
//Em JavaScript, elas são representadas como arrays (por isso a semelhança!), 
//mas são estruturas diferentes. Por exemplo, você pode querer representar um valor como um par de uma 
//string e um número. Para declarar uma tupla, use a sintaxe let variableName: [type, type, ...]:
