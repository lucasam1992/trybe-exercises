...
-- SUBQUERY OU JOIN
-- Decida qual usar através de testes de performance e, em seguida, por afinidade.

-- execution plan , um recurso que nos permite metrificar e comparar quais queries tem 
-- performance melhor para gerar um determinado resultado.
